...
function [outA,outB] = sim_MEGA_PRESS_fast_fastphase_TE140_Lac(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Siemens_MEGA_PRESS_TE140_Lac_101pts_' spinSys '.mat']; % For Philips output
    ...
    editWaveform1       = 'sl_univ_pulse.pta';  % name of 1st single editing pulse waveform.
    
    % Define frequency parameters for editing targets
    flipAngle   = 180;
    centreFreq  = 1.3;              % Center frequency of MR spectrum [ppm]
    editOnFreq1 = 4.1; % 4.1 for Lac; 4.56 for GSH, 1.9 for GABA     % Center frequency of 1st MEGA_PRESS experiment;
    ...
    TE          = 140;              % Echo time [ms]
    TE1         = 6.55*2;           % TE1 [ms] (Use 6.96*2 for Philips Original and 6.55*2 for Universial/Siemens) % Gradient mode at Maximum 13.5uT
    TE2         = TE - TE1;         % TE2 [ms]
