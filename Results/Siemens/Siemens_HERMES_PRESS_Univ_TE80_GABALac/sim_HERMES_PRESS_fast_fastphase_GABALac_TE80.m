...
function [outA,outB,outC,outD] = sim_HERMES_PRESS_fast_fastphase_GABALac_TE80(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Siemens_HERMES_PRESS_GABA_Lac_TE80_101pts_' spinSys '.mat']; 
    
    % General properties of the simulations
    Npts    = 8192;     % number of spectral points
    sw      = 4000;     % spectral width [Hz]
    Bfield  = 2.89;     % Philips magnetic field strength [Tesla]; 3.0 (for Philips); 2.89 (for Siemens);
    ...
    editWaveform2       = 'sl_univ_pulse.pta';  % name of 2nd single editing pulse waveform. [4.1ppm]
    editWaveform3       = 'dl_Siemens_GABA_LAC.pta';   % name of 1st dual editing pulse waveform. [4.1ppm 1.9ppm]
    ...
    editOnFreq3 = (editOnFreq1+editOnFreq2)/2;     % Center frequency of 3rd HERMES experiment [ppm]
...
%     editRF4.tw1 = editRF1.tw1*2;
    ...
    editRF_C      = io_loadRFwaveform(editWaveform3,'inv',0); % dl_Philips_4_1_1_90
    editRF_C.tw1  = 1.8107;
    ...
    editRFonC     = rf_freqshift(editRF_C,editTp3,(centreFreq-editOnFreq3)*Bfield*gamma/1e6); %(4.1 + 1.90)/2
