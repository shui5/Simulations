...
function [outA,outB] = sim_Philips_MEGA_Univ_PRESS_fast_fastphase_TE80_SH_HZ(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Philips_MEGA_Univ_PRESS_1_90_1_50_TE80_' spinSys '.mat']; % For Philips output
    ...
    editOnFreq2 = 1.5;              % Center frequency of 2nd MEGA_PRESS experiment;
