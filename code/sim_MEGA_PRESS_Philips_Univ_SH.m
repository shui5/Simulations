...
%
% DESCRIPTION:
% This script simulates a MEGA-PRESS experiment using Siemens product sequence with fully shaped editing
...
function [outA,outB] = sim_MEGA_PRESS_Philips_Univ_SH(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Philips_MEGA_PRESS_Univ_' spinSys '.mat']; 
    ...
    editOnFreq1 = 4.56;%freq_ppm(1);%4.56; %4.58;                % Center frequency of 1st HERCULES experiment [ppm]
    editOnFreq2 = 7.5; %freq_ppm(2);%7.5; %4.04;                % Center frequency of 2nd HERCULES experiment [ppm]
    %editOnFreq3 = 4.58-(4.58-1.9)/2;   % Center frequency of 3rd HERCULES experiment [ppm]
    %editOnFreq4 = 4.04-(4.04-1.9)/2;   % (need to consider the width of 4.04ppm) % Center frequency of 4th HERCULES experiment [ppm]
       
    % Define pulse durations and flip angles specific for every vendor
    excTp       = 7.20;             % duration of excitation pulse [ms], set to zero for hard pulse
    exc_ref     = 6.2351;
