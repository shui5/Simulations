...
function [outA,outB] = sim_MEGA_PRESS_fast_fastphase_SH(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Philips_MEGA_PRESS_TE110_398' spinSys '.mat']; % For Philips output
    ...
    editOnFreq1 = 3.98; % 4.56 for GSH, 1.9 for GABA     % Center frequency of 1st MEGA_PRESS experiment;
