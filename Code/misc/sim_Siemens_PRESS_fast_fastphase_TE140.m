...
function [out_2]=sim_Siemens_PRESS_fast_fastphase_TE140(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Siemens_PRESS_TE140_101pts_' spinSys '.mat']; 
% ************INPUT PARAMETERS**********************************
...
refTp=4.8; %duration of refocusing pulses[ms]
%6.894 (gtst); %8.53 (sampleRefocPulse); %7.0 (univ_eddenrefo); 4.8 (Mao's); 
...
nX=21;%32; %Number of grid points to simulate in the x-direction
nY=21;%32; %Number of grid points to simulate in the y-direction
