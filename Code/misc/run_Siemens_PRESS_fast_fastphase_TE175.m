...
addpath /Users/steve/Desktop/sim_Siemens_PRESS_fast_fastphase.m/
...
metabolites = {'GABA'};
[out_2] = sim_Siemens_PRESS_fast_fastphase(metabolites);
toc
%time_elapsed=toc;
% outSum.ppm = outA.ppm;
...
x_lim = [1 5];
%y_lim = [-0.2 0.4]
figure(1),subplot(2,1,1),plot(outA.ppm,outA.specs,'r','linewidth',2),set(gca,'xdir','reverse'),xlim(x_lim), xlabel('ppm'),title('A: 1.9ppm')
figure(1),subplot(2,1,2),plot(outB.ppm,outB.specs,'b','linewidth',2),set(gca,'xdir','reverse'),xlim(x_lim), xlabel('ppm'),title('B: 7.5ppm')
