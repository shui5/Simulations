...
function [outA,outB] = sim_Philips_MEGA_Univ_PRESS_fast_fastphase_TE68_SH(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Philips_MEGA_Univ_PRESS_1_90_TE68_' spinSys '.mat']; % For Philips output
