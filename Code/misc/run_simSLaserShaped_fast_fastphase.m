...
centreFreq=4.65;%4.65;%2.3; %= centre frequency of the spectrum in [ppm] (Optional.  Default = 2.3)
...
nX=21;%16; %Number of grid points to simulate in the x-direction
nY=21;%16; %Number of grid points to simulate in the y-direction
te=80;%135;         %sLASER total echo time [ms]
