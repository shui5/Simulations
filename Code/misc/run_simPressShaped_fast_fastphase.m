...
function out_2=run_simPressShaped_fast_fastphase(spinSys)
...
centreFreq=3.0;
Npts=8192;%4096;%2048; %number of spectral points
sw=4000;%5000;%2000; %spectral width [Hz]
Bfield=3; %magnetic field strength [Tesla]
lw=1;%2; %linewidth of the output spectrum [Hz]
thkX=3;%2;%1.66; %slice thickness of x refocusing pulse [cm]
thkY=3;%2;%1.66; %slice thickness of y refocusing pulse [cm]
fovX=4.5;%3;%2.4; %size of the full simulation Field of View in the x-direction [cm]
fovY=4.5;%3;%2.4; %size of the full simulation Field of View in the y-direction [cm]
