...
function [out_2]=sim_PRESS_fast_fastphase_TE30_GE_Probe_P(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['GE_PRESS_TE30_101pts_Probe_P_' spinSys '.mat']; 
% ************INPUT PARAMETERS**********************************
...
refTp=5.2; %6.894 (for gtst);%8.53 (for sampleRefocPulse);%3.5; %duration of refocusing pulses[ms]
flipAngle=137;  %Flip Angle of the refocusing pulses [degrees] (e.g. Use 180 for Siemens PRESS.  Use 137 for GE PRESS).
centreFreq=3.0;
Npts=2048;%2048; %number of spectral points
sw=2500;%2000; %spectral width [Hz]
...
TE          = 30;               % Echo time [ms]
TE1         = 7.876*2; % 7.3 or 7.8 or 7.876           % TE1 [ms] (Use 6.96*2 for Philips Original and 6.55*2 for Universial/Siemens)
TE2         = TE - TE1;         % TE2 [ms]
tau1=TE1;
tau2=TE2;
