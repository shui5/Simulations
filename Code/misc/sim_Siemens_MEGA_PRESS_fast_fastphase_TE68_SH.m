...
function [outA,outB] = sim_Siemens_MEGA_PRESS_fast_fastphase_TE68_SH(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Siemens_MEGA_PRESS_1_90_TE68_' spinSys '.mat']; % For Philips output
