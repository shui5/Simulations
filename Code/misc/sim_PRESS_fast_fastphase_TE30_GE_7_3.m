...
function [out_2]=sim_PRESS_fast_fastphase_TE30_GE_7_3(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['GE_PRESS_TE30_101pts_7_3_' spinSys '.mat']; 
% ************INPUT PARAMETERS**********************************
...
TE          = 30;               % Echo time [ms]
TE1         = 7.3*2; % 7.3 or 7.8 or 7.876           % TE1 [ms] (Use 6.96*2 for Philips Original and 6.55*2 for Universial/Siemens)
TE2         = TE - TE1;         % TE2 [ms]
tau1=TE1;
tau2=TE2;
