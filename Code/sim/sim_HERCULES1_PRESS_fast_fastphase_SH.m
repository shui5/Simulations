...
function [outA,outB,outC,outD] = sim_HERCULES1_PRESS_fast_fastphase_SH(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Philips_HERC1_PRESS_fast_fastphase_' spinSys '.mat']; 
    ...
    editOnFreq1 = 4.58;             % Center frequency of 1st HERCULES_1 experiment [ppm]
    editOnFreq2 = 4.18;             % Center frequency of 2nd HERCULES_1 experiment [ppm]
    editOnFreq3 = (4.58+1.9)/2;     % Center frequency of 3rd HERCULES_1 experiment [ppm]
    editOnFreq4 = (4.18+1.9)/2;     % Center frequency of 4th HERCULES_1 experiment [ppm]
...
%     editRF4.tw1 = editRF1.tw1*2;
    ...
    editRF_C.tw1      = 1.8107;
    editRF_D          = io_loadRFwaveform(editWaveform4,'inv',0);
    editRF_D.tw1      = 1.8107;
    ...
    editRFonB=rf_freqshift(editRF_B,editTp2,(centreFreq-editOnFreq2)*Bfield*gamma/1e6); %4.18
    editRFonC=rf_freqshift(editRF_C,editTp3,(centreFreq-editOnFreq3)*Bfield*gamma/1e6); %(4.58 + 1.90)/2
    editRFonD=rf_freqshift(editRF_D,editTp4,(centreFreq-editOnFreq4)*Bfield*gamma/1e6); %(4.18 + 1.90)/2
