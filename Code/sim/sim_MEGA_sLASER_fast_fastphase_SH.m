...
function [outA,outB] = sim_MEGA_sLASER_fast_fastphase_SH(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Philips_MEGA_sLASER_41pts_' spinSys '.mat'];
    ...
    refWaveform          = 'GOIA'; % adiabatic RF pulse shaped waveform
    editWaveform         = 'sg100_100_0_14ms_88hz.pta';   % name of 1st single editing pulse waveform. %ON/OFF
...
%     TE2         = TE - TE1;         % TE2 [ms]
    ...
    nX      = 21;   % number of spatial points to simulate in x direction
    nY      = 21;   % number of spatial points to simulate in y direction
    nZ      = 21;   % number of spatial points to simulate in z direction
    if nX>1
