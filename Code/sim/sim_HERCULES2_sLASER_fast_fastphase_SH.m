...
%
% DESCRIPTION:
% This script simulates a HERCULES_2 experiment with semi-LASER localization using Philips product sequence with fully shaped editing
...
function [outA,outB,outC,outD] = sim_HERCULES2_sLASER_fast_fastphase_SH(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Philips_HERC2_sLASER_fast_fastphase_' spinSys '.mat'];
    ...
    flipAngle   = 180;
    editOnFreq1 = 4.58;                % Center frequency of 1st HERCULES experiment [ppm]
    editOnFreq2 = 4.04;                % Center frequency of 2nd HERCULES experiment [ppm]
    editOnFreq3 = (4.58+1.9)/2;        % Center frequency of 3rd HERCULES experiment [ppm]
    editOnFreq4 = (4.04+1.9)/2; %+2.14;        % Center frequency of 4th HERCULES experiment [ppm] %Double check center freq
    ...
    switch refocWaveform
        case 'GOIA'
            ...
            load RF_GOIA_20200416_100pts.mat;  %Fill this up
            refRF      = Sweep2;
    ...
    editRF_A          = io_loadRFwaveform(editWaveform1,'inv',0); %4.58
    editRF_A.tw1      = 0.93;   % acquired from check_tw1.m
    editRF_B          = io_loadRFwaveform(editWaveform2,'inv',0); %4.04
    editRF_B.tw1      = 1.4423;
    editRF_C          = io_loadRFwaveform(editWaveform3,'inv',0); %(4.58 + 1.90)/2
    editRF_C.tw1      = 1.8107;
    editRF_D          = io_loadRFwaveform_SH(editWaveform4,'inv',0); %(4.04 + 1.90)/2
    % to flip the HERC2 editing pulse
