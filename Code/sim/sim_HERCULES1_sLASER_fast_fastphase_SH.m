...
function [outA,outB,outC,outD] = sim_HERCULES1_sLASER_fast_fastphase_SH(metabolites)
...
for kk=1:numel(metabolites)
    ...
    spinSys     = metabolite;
    out_name    = ['Philips_HERC1_sLASER_fast_fastphase_' spinSys '.mat'];
    ...
    %editWaveform2       = 'am_sg_150_100_200pts.pta';   % name of 2nd single editing pulse waveform. [4.18ppm]
    ...
    editOnFreq2 = 4.18;                % Center frequency of 2nd HERCULES experiment [ppm]
    editOnFreq3 = (4.58+1.9)/2;        % Center frequency of 3rd HERCULES experiment [ppm]
    editOnFreq4 = (4.18+1.9)/2; %+2.14;        % Center frequency of 4th HERCULES experiment [ppm] %Double check center freq
